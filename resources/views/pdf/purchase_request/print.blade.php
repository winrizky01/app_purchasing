    ...
    <table id="header" style="width: 100%; border:3px; font-size:12pt; margin-bottom:15px">
        <thead>
            <tr>
                ...
                <td colspan="2" style="text-transform: uppercase; text-align:center; border:1px solid;"><strong>Purchase Request</strong></td>
            </tr>
            <tr>
    ...
    <table style="width: 100%; border:3px; font-size:12pt; margin-bottom:15px">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="text-align:center; border:1px solid;">{{ $item->product->name ." / ". $item->product->description }}</td>
