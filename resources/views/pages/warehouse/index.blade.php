...
@section('content')
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTitle">Create Warehouse</h5>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" name="contact_person_number" id="contact_person_number" class="form-control" placeholder="Enter Contact Person Number">
                            </div>
                            <div class="col-md-12 mb-2">
    ...
    <script type="text/javascript">
        // Setup Datatable
        var ajaxUrl  = "{{ url('master/warehouse/dataTables') }}";
        var ajaxData = [];
        var columns  = [{ data: 'code' }, { data: 'name' }, { data: 'contact_person' }, { data: 'status' }, { data: 'action' }];
        var columnDefs  =  [
            {
                // User Status
                targets: -2,
        ...
        var buttons     =  [
            {
                ...
                action: function() {
                    ...
                    $('#modalTitle').text('Create Warehouse');
                    $('#modalCreateEdit form').attr('action', '{{ url("master/warehouse/store") }}');
        ...
        $(document).ready(function() {
            ...
            $('.datatables tbody').on('click', '.edit-record', function() {
                ...
                $('#modalCreateEdit form').attr('action', '{{ url("master/warehouse/update") }}'+ '/' + $(this).data('id'));
            ...
            $('.datatables tbody').on('click', '.delete-record', function() {
                ...
                $('#confirmDelete').attr('action', '{{ url("master/warehouse/delete") }}/' + rowData.id);
        ...
        function fetchData(id){
            $.ajax({
                ...
                // },
                url : '{{ url("master/warehouse?id=") }}'+id,
                data: [],
                type: 'GET',
                headers: {
