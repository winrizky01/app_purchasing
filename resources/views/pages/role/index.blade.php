...
@section('content')
    ...
    <script type="text/javascript">
        // Setup Datatable
        var ajaxUrl  = "{{ url('setting/role/dataTables') }}";
        var ajaxData = [];
        var columns  = [{ data: 'name' }, { data: 'status' }, { data: 'action' }];
        var columnDefs  =  [
            {
                // User Status
                targets: -2,
                ...
                render: function(data, type, full, meta) {
                    return (
                        '<div class="d-flex align-items-center">' +
                            '<a href="{{ url("setting/role/edit") }}/' + full.id +
        ...
        var buttons     =  [
            {
                ...
                text: 'Add Role',
                action: function() {
                    window.location.href = '{{url("setting/role/create")}}'; // Ganti URL_ANDA_DISINI dengan URL yang diinginkan
                }
            }, 
        ]
        // Setup Datatable
        ...
        $(document).ready(function() {
            ...
            $('.datatables tbody').on('click', '.delete-record', function() {
                ...
                $('#confirmDelete').attr('action', '{{url("setting/role/delete")}}/'+rowData.id);
