...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        @if (session('error'))
            <div class="bs-toast toast toast-placement-ex m-2 fade top-0 end-0 show" role="alert" aria-live="assertive" aria-atomic="true" data-bs-delay="5000">
            ...
            <div class="card-body">
                <div class="row pb-2 gap-3 gap-md-0">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" name="filterEmail" id="filterEmail" placeholder="Enter Email">
                    </div>
                    <div class="col-md-4">
    ...
    <script type="text/javascript">
        // Setup Datatable
        var ajaxUrl  = "{{ url('master/user/dataTables') }}";
        var ajaxData = [];
        var columns  = [{ data: 'name' }, {  data: 'email' }, { data: 'role.name' }, { data: 'status' }, { data: 'action' }];
        var columnDefs  =  [
            {
                // User Status
                targets: -2,
                ...
                render: function(data, type, full, meta) {
                    return (
                        '<div class="d-flex align-items-center">' +
                            '<a href="{{ url("master/user/edit") }}/' + full.id +
        ...
        var buttons     =  [
            {
                ...
                text: 'Add User',
                action: function() {
                    window.location.href = '{{url("master/user/create")}}'; // Ganti URL_ANDA_DISINI dengan URL yang diinginkan
                }
            }
        ]
        // Setup Datatable
        ...
        $(document).ready(function() {
            ...
            $('.datatables tbody').on('click', '.delete-record', function() {
                ...
                $('#confirmDelete').attr('action', '{{url("master/user/delete")}}/'+rowData.id);
            ...
            $('#handleFilter').click(function(){
                ...
                ajaxData = {'name':name, 'email':email, 'status': status};
