...
@section('content')
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTitle">Create Division</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form method="POST" id="formDivision">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <label for="department_id" class="form-label">Department</label>
                            <select id="department_id" name="department_id" class="form-select select2" data-allow-clear="true"
                                required>
    ...
    <script type="text/javascript">
        var existingId = "";
        // Setup Datatable
        var ajaxUrl  = "{{ url('master/division/dataTables') }}";
        var ajaxData = [];
        ...
        var buttons     =  [
            {
                ...
                action: function() {
                    ...
                    $('#modalCreateEdit form').attr('action', '{{ url("master/division/store") }}');
        ...
        $(document).ready(function() {
            ...
            $('.datatables tbody').on('click', '.edit-record', function() {
                ...
                $('#modalCreateEdit form').attr('action', '{{ url("master/division/update") }}'+ '/' + $(this).data('id'));
            ...
            $('.datatables tbody').on('click', '.delete-record', function() {
                ...
                $('#confirmDelete').attr('action', '{{ url("master/division/delete") }}/' + rowData.id);
            ...
            $.ajax({
                ...
                success: function(rs) {
                    if(rs.results.length > 0){
                        ...
                        existingId = rs.results[0].department_id;
